...
if("TRUE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/foscar/Molit_2025-main/src/main)
  set(main_DEVEL_PREFIX /home/foscar/Molit_2025-main/devel/.private/main)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/foscar/Molit_2025-main/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/foscar/Molit_2025-main/src/main/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/foscar/Molit_2025-main/devel/.private/main/lib;/home/foscar/Molit_2025-main/devel/lib;/home/foscar/SCMC_2025/devel/lib;/home/foscar/morai_ws/devel/lib;/opt/ros/noetic/lib)
...
set(depends "rospy;gps;planning")
